...
training_session.training_steps.create!(training_step_template_id: template_1.id)
training_session.training_steps.create!(training_step_template_id: template_2.id)
training_session.training_steps.create!(training_steptst_template_id: template_3.id)
